...
type InvestmentWriteRepositoryIF interface {
	...
	FindByID(ctx context.Context, userID string, id uint) (entities.InvestmentEntity, error)
	...
	List(ctx context.Context, userID string, tagNames []string) ([]entities.InvestmentEntity, error)
